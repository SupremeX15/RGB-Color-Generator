...
const gradientColor = `linear-gradient(to right, rgb(${redValue}, ${greenValue}, ${blueValue}), rgb(${255 - redValue}, ${255 - greenValue}, ${255 - blueValue}))`;
document.getElementById("gradient-box").style.background = gradientColor;
}
